...
namespace NSE.Identidade.API.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        private async Task<UsuarioRespostaLogin> GerarJwt(string email)
        {
            ...
            return ObterRepostaToken(user, claims, encodedToken);
        }
        ...
        private UsuarioRespostaLogin ObterRepostaToken(IdentityUser user, IList<Claim> claims, string encodedToken)
        {
